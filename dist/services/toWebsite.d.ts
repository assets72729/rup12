 ...
 */
export declare function addToWebsite(aIOData?: Record<string, any>): Promise<any | null>;
export declare function updateToWebsite(shareId: number, updateQuery: Record<string, any>): Promise<any | null>;
