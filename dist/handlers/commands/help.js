            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!auth.isAdmin(userId ? userId : 0)) {
                        return [2 /*return*/, ctx.reply("to join group :/start")];
                    }
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, ctx.reply("Choose a topic below to get more help:", Markup.inlineKeyboard([
                            [Markup.button.callback("Add New Drama / Series / Movie ", "add")],
                            [Markup.button.callback("Edit Uploaded Drama / Series / Movie ", "edit")],
